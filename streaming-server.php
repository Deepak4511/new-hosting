...
<main>
    ...
    <section id="server-list" class="py-12 px-6 max-w-[1600px] mx-auto">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-black text-deep-purple mb-4">Amsterdam DMCA-Ignored Streaming</h2>
            <p class="text-slate-500">Enterprise Reliability, Instant Scale.</p>
        </div>

        <div class="flex flex-col gap-6">
            <?php foreach ($STREAMING_SERVERS as $server): ?>
