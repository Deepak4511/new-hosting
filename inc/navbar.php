...
<head>
    ...
    <style>
        ...
        .nav-link {
            position: relative;
            font-weight: 600;
            color: #301934; /* Deep Purple instead of Slate */
...
<nav class="fixed w-full z-50 navbar-glass px-6 py-4 transition-all duration-300" id="mainHeader">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <a href="index.php" class="flex items-center gap-2 group z-50 relative">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-wine to-red-purple flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-wine/20 group-hover:scale-110 transition-transform">
                <i class="fas fa-shield-alt"></i>
            </div>
            <span class="text-2xl font-black text-deep-purple tracking-tight">DMCA<span class="text-red-purple">Q</span>Cloud</span>
        </a>
